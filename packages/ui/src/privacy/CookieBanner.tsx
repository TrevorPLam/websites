    ...
    <div className="fixed inset-x-0 bottom-0 z-50 border-t bg-white p-4 shadow-lg">
      <div className="mx-auto max-w-4xl space-y-3">
        <p className="text-sm text-gray-700">
          {businessName} uses cookies to improve your experience. Essential cookies are always on. You can
        ...
        <div className="flex flex-wrap gap-2">
          ...
          <button className="rounded px-4 py-2 text-sm underline" onClick={() => setShowCustomize((v) => !v)}>
