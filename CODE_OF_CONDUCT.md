...
- Taking accountability and learning from mistakes.
...
Maintainers are responsible for clarifying and enforcing this Code of Conduct and may take corrective action in response to behavior deemed inappropriate, threatening, or harmful.
...
Maintainers may apply the following actions:

1. **Correction**: Request behavior change.
2. **Warning**: Formal warning for repeated behavior.
3. **Temporary Ban**: Temporary participation restriction.
