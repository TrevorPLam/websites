...
/**
 * @file test-health-checks.js
 * @summary Simple test script to verify health check system works.
 * @description Tests health check manager functionality and reporting.
