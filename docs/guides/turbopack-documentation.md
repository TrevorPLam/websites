...
4. [Status in Next.js 16](#status-in-nextjs-16)
5. [Configuration](#configuration)
6. [Filesystem Caching](#filesystem-caching)
7. [Aliases & Module Resolution](#aliases--module-resolution)
8. [Loaders](#loaders)
9. [Environment Variables](#environment-variables)
10. [Tree Shaking & Code Splitting](#tree-shaking--code-splitting)
11. [Source Maps](#source-maps)
12. [Migrating from Webpack](#migrating-from-webpack)
13. [Babel Config Detection](#babel-config-detection)
14. [Bundle Analyzer (16.1)](#bundle-analyzer-161)
15. [serverExternalPackages & Transitive Deps](#serverexternalpackages--transitive-deps)
16. [Debugging with --inspect](#debugging-with---inspect)
