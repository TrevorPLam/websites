...
# ============================================================================
# BUNDLE SIZE GATE
# Runs on every PR — fails if any bundle exceeds size-limit budget.
    ...
    steps:
      ...
      - name: Build with bundle analysis
        ...
        env:
          ANALYZE: 'true'
          NODE_ENV: production
          # Use stub env vars — real secrets not needed for build
      ...
      - name: Post bundle size comment on PR
        ...
        with:
          script: |
            ...
            const body = `## Bundle Size Report\n\n| Status | Bundle | Size | Limit | Delta |\n|--------|--------|------|-------|-------|\n${rows}\n\n${process.env.FAILED > 0 ? '> ⚠️ **Bundle size limits exceeded. Fix before merging.**' : '> ✅ All bundle sizes within budget.'}`;
