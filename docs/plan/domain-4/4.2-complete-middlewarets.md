...
- **Task ID:** `DOMAIN-4-001`
- **Status:** ✅ Complete
- **Implementation references:** `packages/infra/middleware/create-middleware.ts`, `packages/infra/__tests__/create-middleware.test.ts`
- **Focused QA:** `pnpm vitest run packages/infra/__tests__/create-middleware.test.ts`
