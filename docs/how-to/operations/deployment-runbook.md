...
description: "> **Internal Document — Customize as needed for your organization.**"
domain: operations
type: how-to
layer: global
...
tags: ["operations", "deployment-runbook.md"]
legacy_path: "infrastructure-devops\deployment-runbook.md"
---
