---
title: "File Header Template"
description: "This guide defines the standard header format for new and substantially modified source files."
domain: development
type: reference
layer: global
audience: ["developer"]
...
tags: ["development", "file", "header", "template"]
legacy_path: "best-practices\file-header-template.md"
---
