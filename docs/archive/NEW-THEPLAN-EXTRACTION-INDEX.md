...
| --------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| 3 evolution principles (improve immediately, migration path, build toward target) | [THEGOAL.md](../../THEGOAL.md), [ROADMAP.md](../../ROADMAP.md) |
| Timeline 26 weeks, Risk low-to-medium, Outcome capability platform                | THEGOAL.md, ROADMAP.md                                         |
| Strangler Fig phase metaphor (Seed→Roots→Trunk→Branches→Canopy)                   | THEGOAL.md, ROADMAP.md                                         |

### Phase 1 (Weeks 1-4)

| NEW.md Content                                                                | Extracted To                                                                                 |
| ----------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| Week 1: Architecture Police (ESLint, no deep imports, warn integration types) | [evol-1-architecture-police.md](../../tasks/evol-1-architecture-police.md), ROADMAP.md       |
...
| Final Checkpoints (weeks 4, 10, 16, 22, 26) | ROADMAP.md, THEGOAL.md, TASKS.md |
...
| -------------------------- | ------------------------------------------------------------------------------------------------ |
| Week 0-26 checkpoint table | [ROADMAP.md](../../ROADMAP.md), [THEGOAL.md](../../THEGOAL.md), [TASKS.md](../../tasks/TASKS.md) |
...
| docs/architecture/\*                            | ✅ Done                | ROADMAP.md, module-boundaries, etc.             |
...
| THEPLAN Content                 | Extracted To         |
| ------------------------------- | -------------------- |
| Pre-Phase, Phase 1-5 sequencing | TASKS.md, ROADMAP.md |
| Security parallel track         | ROADMAP.md, TASKS.md |

### Implementation Order (Section 6)

| Step                                                   | Status                        |
| ------------------------------------------------------ | ----------------------------- |
| 1. Current state audit                                 | ✅ ROADMAP.md § Current State |
| 2. Create evolution-roadmap                            | ✅ Done (in ROADMAP)          |
...
| ----------------------- | -------------------------- |
| Current state vs Week 0 | ROADMAP.md § Current State |
| Security sequencing     | ROADMAP.md                 |
| Pre-Phase blockers      | TASKS.md, ROADMAP.md       |
...
| ----------------------------------------- | ---------------------------------------------------------------- |
| Evolution phases, checkpoints, philosophy | [ROADMAP.md](../../ROADMAP.md) § Organic Evolution               |
| Target architecture, end state            | [THEGOAL.md](../../THEGOAL.md)                                   |
| Task index, execution order               | [tasks/TASKS.md](../../tasks/TASKS.md)                           |
| Source content (archived)                 | [NEW-2026-02-20.md](NEW-2026-02-20.md)                           |
| Executed plan (historical)                | [THEPLAN-2026-02-19-executed.md](THEPLAN-2026-02-19-executed.md) |
