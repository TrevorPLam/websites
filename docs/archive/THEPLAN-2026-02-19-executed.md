# THEPLAN — Execution Plan for NEW.md Alignment [ARCHIVED — EXECUTED]
...
_Original content preserved below for historical reference._
...
_[Sections 2–8 and Appendix preserved as in original — see git history for full content.]_
