...
const faqs = [
  {
    ...
    answer: 'Prices may vary based on hair length, thickness, and the complexity of the service. Your stylist will provide a quote during your consultation.',
  },
  {
    question: 'What is your cancellation policy?',
    answer: 'We require 24 hours notice for cancellations. Cancellations made within 24 hours may be subject to a fee of 50% of the scheduled service.',
  },
  {
    question: 'Do you offer consultations?',
    answer: 'Yes! We offer complimentary 15-minute consultations for all new color and extension clients.',
  },
  {
...
function PricingList({ title, items }: { title: string, items: { name: string, price: string }[] }) {
  return (
    <Card variant="default" className="h-full">
      <h3 className="text-2xl font-bold text-charcoal mb-6 border-b border-teal/20 pb-4">{title}</h3>
