...
- **[2026-02-18] R-PARITY**: Parity testing, refactor validation — see [RESEARCH-INVENTORY.md](RESEARCH-INVENTORY.md#r-parity) for full research findings.
...
- [RESEARCH-INVENTORY.md - R-PARITY](RESEARCH-INVENTORY.md#r-parity) — Full research findings
...
- See [R-PARITY - Research Findings](RESEARCH-INVENTORY.md#r-parity) for additional examples
