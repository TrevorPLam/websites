...
This philosophy document serves as the foundation for all Accessibility domain implementations and should be referenced when making architectural decisions.
