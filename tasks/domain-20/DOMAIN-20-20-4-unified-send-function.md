...
updated: 2026-02-24
owner: 'ai-agent'
branch: feat/DOMAIN-20-20-4-unified-send-function
allowed-tools: Bash(git:*) Read Write Bash(npm:*) Read Write Bash(node:*) Read Write Bash(pnpm:*) Read Write
---

# DOMAIN-20-20-4-unified-send-function

## Objective

Implement 20.4 unified send function for domain following the specifications in the domain plan.

## Context

**Domain:** 20
**Section:** 20.4-unified-send-function
**Files:** Refer to domain plan documentation

**Codebase Area:**

- Location: `docs/plan/domain-20/`
- Focus: 20.4-unified-send-function implementation
...
_Domain: 20_
_Section: 20.4-unified-send-function_
_Priority: High_
