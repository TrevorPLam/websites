...
Define the philosophical foundation and architectural principles for Admin Dashboard domain, establishing the "why" behind implementation decisions and providing context for future development.
...
- Relevant guide docs: frontend/admin
- Architecture patterns: Super admin patterns
...
**Codebase area:** Admin Dashboard domain foundation
...
This philosophy document serves as the foundation for all Admin Dashboard domain implementations and should be referenced when making architectural decisions.
