# scaffold-features-ecommerce Implement ecommerce feature scaffold

## Metadata

- **Task ID**: scaffold-features-ecommerce
- **Owner**: AGENT
...
`packages/features/src/ecommerce/index.ts` is scaffolded but not implemented, leaving an incomplete public surface in `packages/features/src/ecommerce`. This creates capability gaps and blocks roadmap-aligned adoption.
...
- `packages/features/src/ecommerce/` — implement package internals (modify/create)
- `packages/features/src/ecommerce/index.ts` — replace scaffold/stub entrypoint (modify)
- `tasks/scaffold-features-ecommerce.md` — implementation contract (this file)
...
```ts
// packages/features/src/ecommerce/index.ts
