---
id: DOMAIN-28-28-5-sanity-webhook-on-demand-isr
title: '28.5 Sanity Webhook → On-Demand ISR'
status: done
priority: high
type: feature
created: 2026-02-24
updated: 2026-02-24
owner: 'ai-agent'
branch: feat/DOMAIN-28-28-5-sanity-webhook-on-demand-isr
allowed-tools: Bash(git:*) Read Write Bash(npm:*) Read Write Bash(node:*) Read Write Bash(pnpm:*) Read Write
---

# DOMAIN-28-28-5-sanity-webhook-on-demand-isr

## Objective

Implement 28.5 sanity webhook → on-demand isr for domain following the specifications in the domain plan.

## Context

**Domain:** 28
**Section:** 28.5-sanity-webhook-on-demand-isr
**Files:** Refer to domain plan documentation

**Codebase Area:**

- Location: `docs/plan/domain-28/`
- Focus: 28.5-sanity-webhook-on-demand-isr implementation
...
_Domain: 28_
_Section: 28.5-sanity-webhook-on-demand-isr_
_Priority: High_
