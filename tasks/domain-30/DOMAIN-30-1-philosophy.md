...
# ─────────────────────────────────────────────────────────────
id: DOMAIN-30-1-philosophy
title: '30.1 Philosophy'
...
branch: feat/DOMAIN-30-1-philosophy
allowed-tools: Bash(git:*) Read Write Bash(pnpm:*) Bash(node:*)
---

# DOMAIN-30-1 · 30.1 Philosophy

## Objective

Define the philosophical foundation and architectural principles for E2E Testing Suite domain, establishing the "why" behind implementation decisions and providing context for future development.
...
- Relevant guide docs: testing/\*
- Architecture patterns: Playwright patterns
...
**Codebase area:** E2E Testing Suite domain foundation
...
This philosophy document serves as the foundation for all E2E Testing Suite domain implementations and should be referenced when making architectural decisions.
