...
# ─────────────────────────────────────────────────────────────
id: DOMAIN-8-1-philosophy
title: '8.1 Philosophy'
...
branch: feat/DOMAIN-8-1-philosophy
allowed-tools: Bash(git:*) Read Write Bash(pnpm:*) Bash(node:*)
---

# DOMAIN-8-1 · 8.1 Philosophy

## Objective

Define the philosophical foundation and architectural principles for SEO & Metadata domain, establishing the "why" behind implementation decisions and providing context for future development.
...
- Architecture patterns: Metadata factory patterns
...
**Codebase area:** SEO & Metadata domain foundation
...
This philosophy document serves as the foundation for all SEO & Metadata domain implementations and should be referenced when making architectural decisions.
