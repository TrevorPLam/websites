...
updated: 2026-02-24
owner: 'ai-agent'
branch: feat/DOMAIN-19-19-3-calcom-embed-widget-marketing-site
allowed-tools: Bash(git:*) Read Write Bash(npm:*) Read Write Bash(node:*) Read Write Bash(pnpm:*) Read Write
---

# DOMAIN-19-19-3-calcom-embed-widget-marketing-site

## Objective

Implement 19.3 cal.com embed widget (marketing site) for domain following the specifications in the domain plan.

## Context

**Domain:** 19
**Section:** 19.3-calcom-embed-widget-marketing-site
**Files:** Refer to domain plan documentation

**Codebase Area:**

- Location: `docs/plan/domain-19/`
- Focus: 19.3-calcom-embed-widget-marketing-site implementation
...
- Domain Plan: `docs/plan/domain-19/`
...
_Domain: 19_
_Section: 19.3-calcom-embed-widget-marketing-site_
_Priority: High_
