# scaffold-features-notification Implement notification feature scaffold

## Metadata
- **Task ID**: scaffold-features-notification
- **Owner**: AGENT
...
## Context
`packages/features/src/notification/index.ts` is scaffolded but not implemented, leaving an incomplete public surface in `packages/features/src/notification`. This creates capability gaps and blocks roadmap-aligned adoption.
...
## Related Files
- `packages/features/src/notification/` — implement package internals (modify/create)
- `packages/features/src/notification/index.ts` — replace scaffold/stub entrypoint (modify)
- `tasks/scaffold-features-notification.md` — implementation contract (this file)
...
```ts
// packages/features/src/notification/index.ts
