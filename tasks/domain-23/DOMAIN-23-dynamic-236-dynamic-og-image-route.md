---
id: DOMAIN-23-dynamic-236-dynamic-og-image-route
...
updated: 2026-02-23
owner: 'ai-agent'
branch: feat/DOMAIN-23-dynamic-236-dynamic-og-image-route
allowed-tools: Bash(git:*) Read Write Bash(npm:*) Read Write Bash(node:*) Read Write Bash(pnpm:*) Read Write
---

# DOMAIN-23-dynamic-236-dynamic-og-image-route

## Objective

Implement 23.6 dynamic og image route for Domain 23 following the specifications in the domain plan. This task focuses on Domain 23 implementation and ensures proper integration with the existing monorepo architecture.

## Context

**Domain:** Domain 23
**Section:** dynamic
**Files:** 23.6-dynamic-og-image-route.md
...
- Domain Plan: `docs/plan/domain-23/23.6-dynamic-og-image-route.md`
