---
id: DOMAIN-23-per-235-per-tenant-robotstxt
...
updated: 2026-02-23
owner: 'ai-agent'
branch: feat/DOMAIN-23-per-235-per-tenant-robotstxt
allowed-tools: Bash(git:*) Read Write Bash(npm:*) Read Write Bash(node:*) Read Write
---

# DOMAIN-23-per-235-per-tenant-robotstxt

## Objective

Implement 23.5 per-tenant robots.txt for Domain 23 following the specifications in the domain plan. This task focuses on and ensures proper integration with the existing monorepo architecture.
