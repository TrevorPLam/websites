...
|------|-------------------|--------------------|
| **Fix/Blocker** | 0-4, 0-5, 0-6, 0-7 | Run the failing command first (e.g. `pnpm type-check`, `pnpm test`). Fix exact file paths and APIs; preserve consumer contract. |
...
| **API/Integration** | api-*, integration-* | Next.js App Router API routes; site.config-driven; health/OG/adapters. |
