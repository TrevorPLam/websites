...
| Configuration  | `packages/types/src/site-config.ts`, `clients/starter-template/site.config.ts`, `pnpm-workspace.yaml` |
...
- _(Full list retained from prior backlog — 80+ items across Documentation, Technical Debt, Developer Experience, Business Features, Infrastructure, Innovation)_
