...
export const metadata: Metadata = {
  ...
  description: `Review the terms that govern use of the ${siteConfig.name} website.`,
};
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="prose prose-lg max-w-4xl">
            ...
            <p>
              By accessing or using the {siteConfig.name} website (&quot;Site&quot;), you agree to
            ...
            <h2>Services</h2>
            <h3>Description</h3>
            <p>{siteConfig.name} provides [TO BE CUSTOMIZED: describe your hair salon services].</p>
            ...
            <p>
              You agree to indemnify and hold harmless {siteConfig.name} from any claims, damages,
