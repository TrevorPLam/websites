...
const sharedConfig = {
  ...
  moduleNameMapper: {
    ...
    '^@repo/infrastructure-ui$': '<rootDir>/packages/infrastructure/ui/src/index.ts',
    '^@repo/infrastructure-ui/(.*)$': '<rootDir>/packages/infrastructure/ui/src/$1',
    '^@repo/infrastructure-layout$': '<rootDir>/packages/infrastructure/layout/src/index.ts',
    '^@repo/infrastructure-layout/(.*)$': '<rootDir>/packages/infrastructure/layout/src/$1',
    '^@repo/infrastructure-theme$': '<rootDir>/packages/infrastructure/theme/src/index.ts',
    '^@repo/infrastructure-theme/(.*)$': '<rootDir>/packages/infrastructure/theme/src/$1',
  },
  ...
  projects: [
    ...
    // jsdom environment: React components, UI library
    {
      ...
      collectCoverageFrom: [
        ...
        'packages/infrastructure/ui/src/composition/**/*.{ts,tsx}',
        'packages/infrastructure/ui/src/customization/**/*.{ts,tsx}',
        'packages/infrastructure/ui/src/theme/**/*.{ts,tsx}',
        'packages/infrastructure/layout/src/**/*.{ts,tsx}',
        'packages/infrastructure/theme/src/**/*.{ts,tsx}',
        '!**/*.d.ts',
        '!**/index.ts',
        '!**/index.tsx',
      ],
