#!/usr/bin/env tsx
/**
 * @file scripts/execute-high-priority-migration-simple.ts
 * @summary Execute high-priority legacy guides migration with basic frontmatter.
 * @description Migrates top priority legacy documents to new unified structure.
