#!/usr/bin/env tsx
/**
 * @file scripts/execute-phase2-migration.ts
 * @summary Execute Phase 2 migration: Security & Architecture high-priority files.
...
async function main() {
  try {
    ...
    // Save results
    await writeFile('phase2-migration-results.json', JSON.stringify(results, null, 2));
