...
**Evolution alignment:** This game plan maps to [ROADMAP.md](ROADMAP.md) organic evolution phases. See ROADMAP § Organic Evolution for the 26-week Strangler Fig path.

| Waves               | ROADMAP Phase         | Checkpoint                                     |
| ------------------- | --------------------- | ---------------------------------------------- |
