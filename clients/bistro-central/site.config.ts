// Task: [5.3] Example: restaurant industry
...
const siteConfig: SiteConfig = {
  ...
  name: 'Bistro Central',
  tagline: 'Fine dining',
  description: 'Bistro Central — industry: restaurant',
  ...
  footer: {
    ...
    legalLinks: [],
    copyrightTemplate: '© {year} Bistro Central',
  },
  theme: {
    colors: {
      primary: '174 85% 33%',
  ...
  seo: {
    titleTemplate: '%s | Bistro Central',
    defaultDescription: 'Fine dining',
  },
};
