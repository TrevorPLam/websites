  ...
  return (
    <main id="main-content" className="mx-auto max-w-xl px-6 py-16">
      ...
      <p className="mb-8 text-gray-600">
        Under GDPR Article 17 and CCPA, you have the right to request deletion of your personal
        data. Submit your request below and we will process it within 30 days.
      </p>
      <ErasureRequestForm />
    </main>
  );
