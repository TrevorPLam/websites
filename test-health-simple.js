...
/**
 * @file test-health-simple.js
 * @summary Simple test to verify health check system works without Sentry dependencies.
 * @description Tests health check system with minimal dependencies.
...
const {
  HealthCheckManager,
  healthCheckManager,
} = require('./packages/infrastructure/src/monitoring/index.ts');
